...
let thankYou = `Thank you, ${urlParams.get('name')}. You will be contacted within one business day at ${urlParams.get('phone')}. A follow-up email will be sent to ${urlParams.get('email')}`; // etc..... build your message here
